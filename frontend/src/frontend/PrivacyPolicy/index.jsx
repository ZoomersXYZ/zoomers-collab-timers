  ...
  return (
    <>
      ...
      <div id="content">
        ...
        <p>We collect your personal information when you register with us ("User"), when you express an interest in obtaining information about us or our products and services, when you participate in activities on our Website Site (such as using our builder) or otherwise contacting us.</p>
        ...
        <p>Payment Information. If you choose to buy one of our Policy, we collect payment information through our payment processor. All payment information is securely stored by our payment processor and we do not have access to your sensitive information, such as credit card number or security code.</p>
        <p>Business Information. If you choose to create a Policy on our Website, we may ask specific information related to your business in order to create the Policy.</p>
